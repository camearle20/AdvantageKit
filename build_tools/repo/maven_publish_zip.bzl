_TEMPLATE = """
mvn deploy:deploy-file -e -Dmaven.wagon.http.pool=false -DgroupId={group_id} -DartifactId={artifact_id} -Dversion={version} -DrepositoryId={repo_id} -Dpackaging=zip -Dfile={zip_file} -Durl={url} -Dclassifier={classifier} -DgeneratePom=false
"""
